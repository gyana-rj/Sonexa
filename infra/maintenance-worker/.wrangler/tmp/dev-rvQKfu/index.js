...
// src/index.js
import maintenanceHtml from "./07f5c8bf807f0b46b3a8680ba6e54b84477f6b70-maintenance.html";
var RETRY_AFTER_SECONDS = 300;
var src_default = {
  async fetch(request, env) {
    ...
    try {
      response = await fetch(target, {
        ...
        body: request.body,
        redirect: "manual",
        signal: AbortSignal.timeout(Number(env.ORIGIN_TIMEOUT_MS) || 6e4)
      });
    } catch {
      return maintenance(request);
    }
...
__name(isOriginDown, "isOriginDown");
...
// .wrangler/tmp/bundle-PrSgqY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PrSgqY/middleware-loader.entry.ts
